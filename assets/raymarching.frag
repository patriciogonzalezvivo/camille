...
#define SAMPLE_2DCUBE_CELL_SIZE 256.0
// #define SAMPLE_2DCUBE_CELLS_PER_SIDE 8.0
// #define SAMPLE_2DCUBE_FNC(TEX, UV) sampleBicubic(TEX, UV, u_tex0Resolution)
// #define SAMPLE_2DCUBE_FNC(TEX, UV) sampleSmooth(TEX, UV, u_tex0Resolution)
// #define SAMPLE_2DCUBE_FNC(TEX, UV) sampleNearest(TEX, UV, u_tex0Resolution)
